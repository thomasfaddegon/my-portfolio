...
pubDate: "Jan 04 2024"
heroImage: "/blog-headers/header-modern-strategy-games-ui.jpg"
---
...
<div class="caption">
  <em>Age of Wonders 4</em> uses nested tooltips, where hovering over a unit in
  triggers a tooltip, which you can hover to trigger another tooltip, etc.{" "}
</div>
...
<div class="caption">
  <em>Songs of Silence</em> is beautiful, but the placement of tooltips is
  hideous.
</div>

Every time I wanted to understand the cards in my hand, I would have to hover over the card, move my eyes to the top of the screen to read the description, then move by eyes back down to the screen so I could hover over the next card, etc. All the while I’m missing the visually impressive battle unfolding before me (and likely missing the opportune window to cast my abilities).

## _Darkest Dungeon 2_

My frustration started to boil over just a few days later when trying another new, equally visually impressive game, _Darkest Dungeon 2_. During combat, my eyes once again had to perform some uncomfortable ocular gymnastics to understand my character's abilities.

In an almost exact replica of _Rome 2’s_ UI, highlighting an ability will display a tooltip in the bottom right of the screen. Even playing on the compact screen of a Steam Deck, this design choice was jarring and made it take significantly longer for me to understand my available actions.
...
<div class="caption">
  The original <em>Darkest Dungeon</em> had a far superior UI and tooltip
  system.
</div>
...
The role of a UX designer requires navigating the delicate balance between aesthetics and functionality, and often entails pushing back against visually appealing designs that sacrifice practicality for beauty. Thankfully, creating a user interface that excels in both aesthetics and functionality is not an either/or proposition, and while it may take more time, the extra effort is _always_ worth the results.
